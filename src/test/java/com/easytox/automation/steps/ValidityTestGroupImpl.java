 ...
 */
public class ValidityTestGroupImpl {
...
//        }
    ...
    public void user_do_not_submit_the_data() throws InterruptedException {
        ...
        Assert.assertEquals(title, ValidityTestGroupImpl.TestCode.TITLE_VALUE);
    ...
    public void clicks_on_x_button() {
        ...
        WebElement xButton = MyWebDriverUtils.findElement(driver, ValidityTestGroupImpl.TestCode.X_BUTTON_LOCATOR, LocatorType.CSS);
        if (xButton != null) {
            xButton.click();
        }
    }
    ...
    public void check_number_of_records(String number) throws InterruptedException {
        ...
        WebElement element = driver.findElement(By.id(ValidityTestGroupImpl.TestCode.PAGINATE_LOCATOR));
    ...
    public void click_on_test_code_column() throws InterruptedException {
        ...
        driver.findElement(By.cssSelector(ValidityTestGroupImpl.TestCode.TEST_CODE_COLUMN_LOCATOR)).click();
    }
    ...
    public void display_in_the_alphabetical_orders() {
        ...
        if (allRows.get(0).findElements(By.xpath(CELLS_LOCATOR)).get(0)
                .getAttribute(ValidityTestGroupImpl.TestCode.SORT_ATTRIBUTE_LOCATOR) != null &&
                allRows.get(0).findElements(By.xpath(CELLS_LOCATOR)).get(0)
                        .getAttribute(ValidityTestGroupImpl.TestCode.SORT_ATTRIBUTE_LOCATOR).equals(ValidityTestGroupImpl.TestCode.SORT_ATTRIBUTE_VALUE)) {
            j = 0;
        }
    ...
    public void click_on_description_column() throws InterruptedException {
        Thread.sleep(TIME_STOP);
        driver.findElement(By.cssSelector(ValidityTestGroupImpl.TestCode.DESCRIPTION_COLUMN_LOCATOR)).click();
    }
    ...
    public void click_on_compounds_column() throws InterruptedException {
        Thread.sleep(TIME_STOP);
        driver.findElement(By.cssSelector(ValidityTestGroupImpl.TestCode.COMPOUNDS_COLUMN_LOCATOR)).click();
    }
    ...
    public void click_on_edit_button() throws InterruptedException {
        Thread.sleep(TIME_STOP);
        driver.findElement(By.cssSelector(ValidityTestGroupImpl.TestCode.EDIT_BUTTON_LOCATOR)).click();
    }

    @Then("^“Edit Validity Test Code” popup should be displayed$")
    public void check_edit_test_code_popup() throws InterruptedException {
        WebElement webElement = MyWebDriverUtils.findElement(driver, ValidityTestGroupImpl.TestCode.TITLE_LOCATOR, LocatorType.ID);
        if (webElement != null) {
            String title = webElement.getText();
            Assert.assertEquals(title, ValidityTestGroupImpl.TestCode.EDIT_VALIDITY_TEST_CODE);
        } else {
            Assert.fail("webElement is null!");
        }

        WebElement testCode = MyWebDriverUtils.findElement(driver, ValidityTestGroupImpl.TestCode.TEST_CODE_LOCATOR, LocatorType.ID);
        if (testCode != null) {
        ...
        WebElement compounds = MyWebDriverUtils.findElement(driver, ValidityTestGroupImpl.TestCode.COMPOUND_EDIT_LOCATOR, LocatorType.CSS);
        if (compounds != null) {
    ...
    public void update_test_code() throws InterruptedException {
        ...
        WebElement updateButton = MyWebDriverUtils.findElement(driver, ValidityTestGroupImpl.TestCode.UPDATE_BUTTON_LOCATOR, LocatorType.CSS);
    ...
    public void check_list_with_edited_data() throws InterruptedException {
        ...
        Assert.assertTrue(driver.findElement(By.cssSelector(ValidityTestGroupImpl.TestCode.UPDATE_HELP_BLOCK_LOCATOR)).isDisplayed());
        boolean flag = false;
        WebElement table = driver.findElement(By.id(TABLE_LOCATOR));

        List<WebElement> allRows = table.findElements(By.tagName(ROWS_LOCATOR));
        List<WebElement> cells = allRows.get(1).findElements(By.xpath(CELLS_LOCATOR));
        if (cells.get(1).getText().equals(ValidityTestGroupImpl.TestCode.DESCRIPTION_NEW_VALUE) && cells.get(2).getText().equals(ValidityTestGroupImpl.TestCode.COMPOUNDS_VALUE)) {
            flag = true;
        }
        Assert.assertTrue(flag);
    }
    ...
    public void click_on_close_button_in_edit_test_code_popup() throws InterruptedException {
        ...
        WebElement closeButton = MyWebDriverUtils.findElement(driver, ValidityTestGroupImpl.TestCode.EDIT_CLOSE_BUTTON_LOCATOR, LocatorType.CSS);
        if (closeButton != null) {
            closeButton.click();
        } else {
    ...
    public void click_on_x_in_edit_test_code_popup() throws InterruptedException {
        ...
        WebElement xButton = MyWebDriverUtils.findElement(driver, ValidityTestGroupImpl.TestCode.EDIT_X_BUTTON_LOCATOR, LocatorType.CSS);
        if (xButton != null) {
            xButton.click();
        } else {
    ...
    public void click_on_next_button() throws InterruptedException {
        ...
        if (table != null) {
            ...
            driver.findElement(By.cssSelector(ValidityTestGroupImpl.TestCode.NEXT_BUTTON_LOCATOR)).click();
        } else {
            Assert.fail("table is null!");
        }
    }
    ...
    public void navigate_to_the_next_page() {
        ...
        WebElement el = driver.findElement(By.xpath(ValidityTestGroupImpl.TestCode.PAGINATE_2_LOCATOR));
    ...
    public void click_on_prev_button() throws InterruptedException {
        ...
        WebElement prevButton = MyWebDriverUtils.findElement(driver, ValidityTestGroupImpl.TestCode.PREVIOUS_BUTTON_LOCATOR, LocatorType.CSS);
        if (prevButton != null) {
            prevButton.click();
        } else {
    ...
    public void navigate_to_previous_page() {
        ...
        checkList();
        WebElement el = driver.findElement(By.xpath(ValidityTestGroupImpl.TestCode.PAGINATE_1_LOCATOR));
    ...
    public void user_searches_the_results() throws InterruptedException {
        WebElement input = MyWebDriverUtils.findElement(driver, ValidityTestGroupImpl.TestCode.SEARCH_INPUT_LOCATOR, LocatorType.XPATH);
        if (input != null) {
    ...
    public void show_message() {
        WebElement webElement = MyWebDriverUtils.findElement(driver, ValidityTestGroupImpl.TestCode.MESSAGE_INFO_LOCATOR, LocatorType.ID);
        if (webElement != null) {
            String text = webElement.getText();
            boolean flag = text.contains(ValidityTestGroupImpl.TestCode.MESSAGE_VALUE);
            Assert.assertTrue(flag);
        } else {
            Assert.fail("webElement is null!");
        }
...
//    }
    ...
    private void edit() {
        ...
        if (description != null) {
            description.clear();
            description.sendKeys(ValidityTestGroupImpl.TestCode.DESCRIPTION_NEW_VALUE);
            Assert.assertEquals(description.getAttribute(ATTRIBUTE_VALUE_LOCATOR), ValidityTestGroupImpl.TestCode.DESCRIPTION_NEW_VALUE);
        } else {
            Assert.fail("description is null!");
        }

        driver.findElement(By.cssSelector(ValidityTestGroupImpl.TestCode.COMPOUND_X_LOCATOR)).click();

        WebElement compounds = MyWebDriverUtils.findElement(driver, ValidityTestGroupImpl.TestCode.COMPOUNDS_EDIT_LOCATOR, LocatorType.CSS);
        if (compounds != null) {
            compounds.sendKeys(ValidityTestGroupImpl.TestCode.COMPOUNDS_VALUE);
        } else {
            Assert.fail("compounds is null!");
        }

        driver.findElement(By.cssSelector(ValidityTestGroupImpl.TestCode.COMPOUND_SELECT_LOCATOR)).click();
    }
